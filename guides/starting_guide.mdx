...
<div style={{ overflow: 'hidden' }}>
  ...
  <Card title="Shops" icon="shop" href="/map/shops">
  ...
  <Card title="Fishing" icon="fish" href="/gameplay/fishing">
  ...
  <Card title="Research Tent" icon="tent" href="/items/research_tent">
  ...
  * A hatchet or chainsaw. If you stumble across a chainsaw, that's cool too, but the hatchet will give you more wood, which is really what we're after right now.
  ...
  <Card title="Building a House" icon="house" href="/guides/building_a_house">
  ...
  **You are finished, now get out there and explore the map!**
  ...
  <img style={{ borderRadius: '0.5rem' }} src="https://i.imgur.com/4O3ciF2.png" />
</div>