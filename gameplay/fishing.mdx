...
<Tabs>
  <Tab title="Common">
    ...
    | ---- | ------ | ------------- | ---------------- |
    | Perch | 10 | ~50 Mk | Sgt. Lake's Kitchen |
    | Pike | 14 | ~90 Mk | Sgt. Lake's Kitchen |
    | Salmon | 13 | ~100 Mk | Sgt. Lake's Kitchen |
    | Tuna | 10 | ~230 Mk | Sgt. Lake's Kitchen |
    | Cave Crab | 13 | ~64 Mk | James General Store |
  </Tab>
  <Tab title="Rare">
    | Name | Energy | Selling Price | Selling Location |
    | ---- | ------ | ------------- | ---------------- |
    ...
    | Catfish | 20 | ~210 Mk | Sgt. Lake (NPC) |
  </Tab>
  <Tab title="Epic">
    | Name | Energy | Selling Price | Selling Location |
    | ---- | ------ | ------------- | ---------------- |
    ...
    | Stingray | 35 | ~1,000 Mk | Sgt. Lake (NPC) |
  </Tab>
  <Tab title="Legendary">
    | Name | Energy | Selling Price | Selling Location |
    | ---- | ------ | ------------- | ---------------- |
    | Misty Grouper | 40 | ~4,000 Mk | Sgt. Lake (NPC) |
    | Swordfish | 42 | ~2,000 Mk | Sgt. Lake (NPC) |
    | Axolotl | 20 | ~4,000 Mk | Dan (Mining NPC) |
    | Salmon Shark | 90 | ~3,000 Mk | Sgt. Lake (NPC) |
  </Tab>
</Tabs>


  <img src="https://uo.uuvana.com/longvinter/assets/img/fish_list.png" alt="Fish Compendium" />
